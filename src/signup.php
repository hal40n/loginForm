          ...
          <form action="register.php" method="POST">
            <div class="max-w-md mx-auto">
              <div>
                ...
                <p class="text-gray-600 text-sm">Plz insert your information</p>
              </div>
              <div class="divide-y divide-gray-200">
                <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                  ...
                  <div class="relative">
                    <button type="submit" name="login" value="login" class="bg-cyan-500 text-white rounded-md px-2 py-1">Register</button>
                  </div>
                </div>
              </div>
            </div>
